# Hardhat Dynamic On Chain Nft Mint Contract

This is a simple NFT contract that lets you mint dynamic nfts stored on-chain. 
- Once an Nft is minted it will start as a seed.
- After a set duration, the Nft will then transition into a seedling.
- Finally it will reach it's last stage and turn into a flower.
- This cycle will then reset and repeat itself.

Tools
- Chainlink keepers was used to help automate the whole process of dynamically changing the Nft as it goes through the stages.
- Base64 library was used to encode our images and store them on-chain
...
```
git clone https://github.com/areezladhani/Dynamic-on-chain-NFT
cd hardhat-raffle
yarn
```
